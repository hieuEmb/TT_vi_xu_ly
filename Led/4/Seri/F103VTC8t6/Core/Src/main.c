...
//ghi gia tri vao mang.
	sprintf(dem, "%0d%0d:%0d%0d", a2, a1, a3, a4);	
//dinh dang dong ho, tang dan
	led(0, a2);//(min, a2=0)
	led(1, a1);//(min, a1=0)
	led(3, a3);//(sec, a3=0)
	led(4, a4);//(sec, a4=0)
	...
	//HAL_Delay(100);
	if (strcmp((char *)rx_buffer, dem)==0) {
...
//		led(3, a3);//(sec, a3=0)
//		led(4, a4);//(sec, a4=0)
//		//a4++;// thoi gian tang cho a4++ la 1s, trong khi thoi gian quet led la rat nho.
//		if (a4==10){
//			a3++;
//			a4=0;
//		}
